...
import com.example.duantn.config.ConfigVNPay;
...
@RestController
@RequestMapping("/apivnpay")   //  /api/paymentvnpay/create
public class PaymentController {
    @GetMapping("/create")
    public ResponseEntity<String> createPaymentByVNPay(
        ...
        return ResponseEntity.status(HttpStatus.FOUND).header("Location", paymentUrl).body(paymentUrl);
    }
