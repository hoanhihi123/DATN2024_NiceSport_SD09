...
<%--                                <li class="active">Sửa thông tin chức vụ</li>--%>
<%--                            </ol>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin chức vụ</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/chuc-vu/sua/${chucVu.id}" method="post" modelAttribute="chucVu" class="row">
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungMa==true}">
                                <p class="text-danger">Mã chức vụ đã có trong hệ thống, vui lòng nhập mã mới</p>
                            </c:if>
                        </div>
                        <div class="col-lg-6">
                            <span>Tên chức vụ(<i class="fa fa-asterisk" style="color: red;"></i>)</span>
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/chuc-vu/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
